...
public void updatePasswordSeguro(Long usuarioId, String nuevoPasswordPlano, String ignorar) throws SQLException {
    ...
    String salt = com.integradorfinal.programacion2.util.PasswordUtil.generateSalt(16);
    String hash = com.integradorfinal.programacion2.util.PasswordUtil.hashPassword(nuevoPasswordPlano, salt);
