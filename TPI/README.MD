...
- Esto cambia la conexion para correr el programa desde NetBeans (o cualquier otra IDE)
...
#### Para compilar, se debe configurar el db.resourses que se encuentra en target
