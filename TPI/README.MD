...
https://github.com/MatiasManuelCarro/UTN-TUPaD-P2_TPI_Grupo18/blob/main/TPI/UML.png

---

Link al Documento del proyecto:

https://github.com/MatiasManuelCarro/UTN-TUPaD-P2_TPI_Grupo18/blob/main/TPI/TPI%20Programacion%202%20-%20Grupo%2018%20-%20Hugo%20Catalan%2C%20Ignacio%20Carn%C3%A9%2C%20Matias%20Carro%2C%20Gabriel%20Carbajal%20.pdf
...
### 1. Crear la base de datos, podes utilizar el script que se encuentra en: 

> TPI\programacion2Base_de_datos_Grupo_18.sql
...
#### Esta configuracion es para la conexion desde NetBeans o cualquier IDE

##### Para cambiar la configuración (coneccion de la base de datos) ir dentro del proyecto a:

src/main/resources y modificar el archivo "db.properties"

> \src\main\resources\db.properties

https://github.com/MatiasManuelCarro/UTN-TUPaD-P2_TPI_Grupo18/tree/main/TPI/programacion2/src/main/resources


#### Tambien el que se encuentra dentro de target

> target\classes\db.properties

Y modificar el archivo de la misma manera.

> https://github.com/MatiasManuelCarro/UTN-TUPaD-P2_TPI_Grupo18/tree/main/TPI/programacion2/target/classes
...
### Los datos de los usuarios para probar son:

| id_usuario | id_credencial | usuario          | mail                       |
|------------|---------------|------------------|----------------------------|
| 1          | 1             | matias.carro     | matias.carro@mail.com      |
| 2          | 2             | hugo.catalan     | hugo.catalan@mail.com      |
| 3          | 3             | ignacio.carne    | ignacio.carne@mail.com     |
| 4          | 4             | gabriel.carbajal | gabriel.carbajal@mail.com  |

---

## Antes de Compilar:

- Verificar tener las configuracion correctas:
- Maven funcionando
- UTF 8 configurado 
- db.resources configurado

### Como configurar Maven

1. Ir a variables del entorno.

2. Crear en variables del usuario:

> M2_HOME

> MAVEN_HOME

Ambas deben tener la ubicacion de la carpeta descomprimida de Maven (Por ejemplo: C\\:apache-maven-3.9.11)

3. En variables del sistema crear la variable:

> MAVEN_HOME

En esta tambien debe tener la ubicacion de la carpeta descomprimida de Maven (Por ejemplo: C\\:apache-maven-3.9.11)

4. ir a Path dentro de variables del sistema y crear uno nuevo. 

Con la ubicacion de la carpeta Maven\bin (Por ejemplo: C\\:apache-maven-3.9.11\bin )

### Nota: guias de como hacerlos se encuentran en la Carpeta Extras del repositorio

https://github.com/MatiasManuelCarro/UTN-TUPaD-P2_TPI_Grupo18/blob/main/TPI/Extras/CONFIGURAR_MAVEN.png


---

### Como configurar UTF-8 en java (Se encuentra una guia con imagenes en la carpeta Extras del repo)

```
1. Ir a variables del entorno.

2. Agregar una nueva llamada JAVA_TOOL_OPTIONS

3. Ingresar el siguiente valor:
...
https://github.com/MatiasManuelCarro/UTN-TUPaD-P2_TPI_Grupo18/tree/main/TPI/Extras
...
- Recorda configurar db.resources para poder conectar
...
- De esta manera compila, recorda configurar los db.resources
...
- Crea una contraseña para un usuario nuevo, que se haya creado sin contraseña (para darle el alta a la cuenta en otra fecha mas adelante)
...
Password (se guardará el hash SHA-256): 12345
Conectado correctamente a la base de datos.
...
Usuario demo creado con ID (sin commit): 62
> Se ejecutó ROLLBACK correctamente.
Conexión cerrada correctamente.
La operación falló y se revirtió completamente.
```

Al final, podes verificar que la transaccion falló y ningun usuario se creo. 
...
Configurar correctamente los archivos db.resource

- Da error de UTF-8 

Configurar correctamente la variable del entorno para UTF

- No funciona correctamente maven (o la consola no reconoce el comando mvn)

Configurar correctamente las variables del entorno de Maven y el Path
...
│   └── (default package)                            # Clases de prueba
│
...
│
└── Java Dependencies/                               # Dependencias del JDK
    └── JDK 24 (Default)                             # Con compatibilidad a partir de 17
```
...
- Se encuentra dentro de la carpeta docs

> TPI\programacion2\doc

- Abrir index.html

https://github.com/MatiasManuelCarro/UTN-TUPaD-P2_TPI_Grupo18/tree/main/TPI/programacion2/doc
